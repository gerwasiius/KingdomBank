namespace Bank.Infrastructure.Identity.KeyVault;
...
public sealed class FileKeyVault : IKeyVault
{
    ...
    public async Task StorePrivateKeyAsync(KeyDescriptor d, byte[] privateKeyPem, CancellationToken ct = default)
    {
        ...
        // public JWK vec dolazi iz generatora ? cuva ga caller (vidjet ceš u workeru); ovdje pružamo i helper:
    ...
    // Helper – upiši JWK (pozvat cemo iz workera nakon generisanja)
